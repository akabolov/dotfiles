...
set -U fish_user_paths $HOME/.bin  $HOME/.local/bin /opt/homebrew/bin $HOME/Applications /var/lib/flatpak/exports/bin/ $fish_user_paths $HOME/.local/share/nvm /opt/homebrew/Cellar/postgresql@15/15.3_2/bin/ $HOME/go/bin $HOME/.npm-global/bin
